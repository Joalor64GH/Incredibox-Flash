...
(window._gsQueue || (window._gsQueue = [])).push(function () {
                  ...
                  if (
                      (t >= u
                          ...
                          ? ((this._totalTime = this._time = this._cycle = 0),
                            ...
                            (0 !== f || (0 === this._duration && this._rawPrevTime > 0)) && ((r = "onReverseComplete"), (s = this._reversed)),
                          ...
                          : ((this._totalTime = this._time = t),
                            ...
                            this._easeType
                                ? ((h = this._time / this._duration),
                                  ...
                                  (this.ratio = 1 === l ? 1 - h : 2 === l ? h : 0.5 > this._time / this._duration ? h / 2 : 1 - h / 2))
                          ...
                          (t >= l
                              ? ((this._totalTime = this._time = l),
                                this._reversed ||
                                    ...
                                    ((n = !0), (o = "onComplete"), 0 === this._duration && (0 === t || 0 > this._rawPrevTime) && this._rawPrevTime !== t && this._first && ((h = !0), this._rawPrevTime > 0 && (o = "onReverseComplete"))),
                                (this._rawPrevTime = t),
                                (t = l + 1e-6))
                              : 1e-7 > t
                              ? ((this._totalTime = this._time = 0),
                                (0 !== _ || (0 === this._duration && this._rawPrevTime > 0)) && ((o = "onReverseComplete"), (n = this._reversed)),
                                0 > t ? ((this._active = !1), 0 === this._duration && this._rawPrevTime >= 0 && this._first && (h = !0), (this._rawPrevTime = t)) : ((this._rawPrevTime = t), (t = 0), this._initted || (h = !0)))
                      ...
                      if (
                          (t >= _
                              ? (this._locked || ((this._totalTime = _), (this._cycle = this._repeat)),
                                this._reversed ||
                                    this._hasPausedChild() ||
                                    ((n = !0), (o = "onComplete"), 0 === u && (0 === t || 0 > this._rawPrevTime) && this._rawPrevTime !== t && this._first && ((h = !0), this._rawPrevTime > 0 && (o = "onReverseComplete"))),
                                (this._rawPrevTime = t),
                                this._yoyo && 0 !== (1 & this._cycle) ? (this._time = t = 0) : ((this._time = u), (t = u + 1e-6)))
                              : 1e-7 > t
                              ? (this._locked || (this._totalTime = this._cycle = 0),
                                (this._time = 0),
                                (0 !== p || (0 === u && this._rawPrevTime > 0 && !this._locked)) && ((o = "onReverseComplete"), (n = this._reversed)),
                                0 > t ? ((this._active = !1), 0 === u && this._rawPrevTime >= 0 && this._first && (h = !0), (this._rawPrevTime = t)) : ((this._rawPrevTime = t), (t = 0), this._initted || (h = !0)))
              ...
              m = window._gsDefine.plugin({
                  ...
                  init: function (t, e, i) {
                      ...
                      for (n = this._props.length; --n > -1; )
                          (s = this._props[n]),
                              ...
                              o || (l[s] !== h[0][s] && (o = l));
                      if (
                          ((this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? u(h, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, o) : p(h, e.type, l)),
                  ...
                  set: function (e) {
                      ...
                      for (s = 1 - o, r = this._props.length; --r > -1; )
                          (n = this._props[r]), (a = this._beziers[n][i]), (h = (o * o * a.da + 3 * s * (o * a.ca + s * a.ba)) * o + a.a), this._round[n] && (h = (h + (h > 0 ? 0.5 : -0.5)) >> 0), f[n] ? c[n](h) : (c[n] = h);
                      if (this._autoRotate) {
                          var m,
                              d,
                              g,
                          ...
                          parser: function (t, i, a, o, h, l) {
                              ...
                              return (
                                  ...
                                  !g.autoRotate ||
                                      ...
                                      ((_ = g.autoRotate === !0 ? 0 : Number(g.autoRotate) * e), (g.autoRotate = null != p.end.left ? [["left", "top", "rotation", _, !0]] : null != p.end.x ? [["x", "y", "rotation", _, !0]] : !1)),
      ...
      window._gsDefine(
          ...
          function (t, e) {
              ...
              (h.constructor = a),
                  ...
                  (h = "px"),
                  (a.suffixMap = { top: h, right: h, bottom: h, left: h, width: h, height: h, fontSize: h, padding: h, margin: h, perspective: h });
              var l,
                  _,
                  u,
                  p,
                  ...
                  G = (a.getStyle = function (t, e, i, s, r) {
                      var n;
                      return U || "opacity" !== e
                          ? (!s && t.style[e] ? (n = t.style[e]) : (i = i || Z(t, null)) ? ((t = i.getPropertyValue(e.replace(P, "-$1").toLowerCase())), (n = t || i.length ? t : i[e])) : t.currentStyle && (n = t.currentStyle[e]),
                      ...
                      return (
                          ...
                          "%" === s && -1 !== e.indexOf("border")
                              ...
                              : ((h.cssText = "border-style:solid;border-width:0;position:absolute;line-height:0;"),
                                "%" !== s && o.appendChild ? (h[a ? "borderLeftWidth" : "borderTopWidth"] = i + s) : ((o = t.parentNode || E.body), (h[a ? "width" : "height"] = i + s)),
                                o.appendChild(N),
                  ...
                  W = function (t, e) {
                      var i,
                          ...
                          r = {};
                      if ((e = e || Z(t, null)))
                          if ((i = e.length)) for (; --i > -1; ) r[e[i].replace(k, R)] = e.getPropertyValue(e[i]);
                  ...
                  H = function (t, e, i, s, r) {
                      ...
                      for (a in i)
                          "cssText" !== a &&
                              ...
                              ((h[a] = "auto" !== n || ("left" !== a && "top" !== a) ? (("" !== n && "auto" !== n && "none" !== n) || "string" != typeof e[a] || "" === e[a].replace(v, "") ? n : 0) : Q(t, a)),
              ...
              var le = function (t, e, i, s) {
                  ...
                  fe = (a.parseComplex = function (t, e, i, s, r, n, a, o, h, _) {
                      ...
                      var u,
                          ...
                          C = l !== !1;
                      for (
                          (-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && ((S = S.join(" ").replace(D, ", ").split(" ")), (R = R.join(" ").replace(D, ", ").split(" ")), (A = S.length)),
                              A !== R.length && ((S = (n || "").split(" ")), (A = S.length)),
                              a.plugin = h,
                              a.setRatio = _,
                              u = 0;
                          A > u;
              ...
              var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),
                      ...
                      if (16 === n.length) {
                          ...
                          if ((v.zOrigin && ((D = -v.zOrigin), (A = k * D - n[12]), (O = S * D - n[13]), (D = R * D + v.zOrigin - n[14])), !i || s || null == v.rotationX)) {
                              ...
                              Q &&
                                  ...
                                  (v.scaleX = (0 | (Math.sqrt(z * z + U * U) * w + 0.5)) / w),
                                  (v.scaleY = (0 | (Math.sqrt(q * q + S * S) * w + 0.5)) / w),
                                  (v.scaleZ = (0 | (Math.sqrt(V * V + R * R) * w + 0.5)) / w),
                                  (v.skewX = 0),
                                  (v.perspective = $ ? 1 / (0 > $ ? -$ : $) : 0),
                                  (v.x = A),
                                  (v.y = O),
                  ...
                  Pe = function (t) {
                      ...
                      if (p) {
                          ...
                          var f,
                              ...
                              b = s.y;
                          if (
                              (null != s.ox && ((f = (s.oxp ? 0.01 * d * s.ox : s.ox) - d / 2), (m = (s.oyp ? 0.01 * g * s.oy : s.oy) - g / 2), (x += f - (f * o + m * h)), (b += m - (f * l + m * _))),
                              v ? ((f = d / 2), (m = g / 2), (w += ", Dx=" + (f - (f * o + m * h) + x) + ", Dy=" + (m - (f * l + m * _) + b) + ")")) : (w += ", sizingMethod='auto expand')"),
                  ...
                  ke = function () {
                      ...
                      if (
                          (p &&
                              ((P = A.top ? "top" : A.bottom ? "bottom" : parseFloat(G(this.t, "top", null, !1)) ? "bottom" : "top"),
                              (T = G(this.t, P, null, !1)),
                              (k = parseFloat(T) || 0),
                              (S = T.substr((k + "").length) || "px"),
                              (R._ffFix = !R._ffFix),
                              (A[P] = (R._ffFix ? k + 0.05 : k - 0.05) + S)),
                          C || R.skewX)
                      )
                          (v = Math.cos(C)), (y = Math.sin(C)), (t = v), (r = y), R.skewX && ((C -= R.skewX), (v = Math.cos(C)), (y = Math.sin(C))), (e = -y), (n = v);
                      else {
                      ...
                      (_ = 1),
                          ...
                          (g = 1e5),
                          (C = R.rotationY),
                          C && ((v = Math.cos(C)), (y = Math.sin(C)), (h = _ * -y), (f = m * -y), (i = t * y), (a = r * y), (_ *= v), (m *= v), (t *= v), (r *= v)),
                          (C = R.rotationX),
                          C &&
                              ((v = Math.cos(C)),
                              (y = Math.sin(C)),
                          ...
                          (s = (T = (s += R.x) - (s |= 0)) ? (0 | (T * g + (0 > T ? -0.5 : 0.5))) / g + s : s),
                          (o = (T = (o += R.y) - (o |= 0)) ? (0 | (T * g + (0 > T ? -0.5 : 0.5))) / g + o : o),
                          (u = (T = (u += R.z) - (u |= 0)) ? (0 | (T * g + (0 > T ? -0.5 : 0.5))) / g + u : u),
                          (A[ye] =
                              "matrix3d(" +
                              [
                                  (0 | (t * g)) / g,
                      ...
                      p &&
                          ...
                          l.rotation || l.skewX
                              ? ((r = l.rotation),
                                ...
                                (o = l.scaleX * a),
                                (h = l.scaleY * a),
                                (u[ye] = "matrix(" + (0 | (Math.cos(r) * o)) / a + "," + (0 | (Math.sin(r) * o)) / a + "," + (0 | (Math.sin(n) * -h)) / a + "," + (0 | (Math.cos(n) * h)) / a + "," + l.x + "," + l.y + ")"))
              ...
              de(
                      ...
                      parser: function (t, e, i, s, n, a, o) {
                          ...
                          if ("string" == typeof y.transform && ye) (_ = d.cssText), (d[ye] = y.transform), (d.display = "block"), (h = be(t, null, !1)), (d.cssText = _);
                              ...
                              (h.rotation = re("rotation" in y ? y.rotation : "shortRotation" in y ? y.shortRotation + "_short" : "rotationZ" in y ? y.rotationZ : m.rotation * I, m.rotation, "rotation", T)),
                                  xe &&
                                      ((h.rotationX = re("rotationX" in y ? y.rotationX : "shortRotationX" in y ? y.shortRotationX + "_short" : m.rotationX * I || 0, m.rotationX, "rotationX", T)),
                          ...
                          for (
                              null != y.force3D && ((m.force3D = y.force3D), (f = !0)), p = m.force3D || m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective, p || null == y.scale || (h.scaleZ = 1);
                              --v > -1;
                  ...
                  de("clip", {
                      ...
                      parser: function (t, e, i, s, n, a) {
                          ...
                          return (
                              9 > c
                                  ? ((h = t.currentStyle), (l = 8 > c ? " " : ","), (o = "rect(" + h.clipTop + l + h.clipRight + l + h.clipBottom + l + h.clipLeft + ")"), (e = this.format(e).split(",").join(l)))
              ...
              (h = a.prototype),
                  ...
                  (h._onInitTween = function (t, e, o) {
                      ...
                      if (
                          ...
                          "string" == typeof e && ((m = x.cssText), (h = W(t, r)), (x.cssText = m + ";" + e), (h = H(t, h, W(t)).difs), !U && w.test(e) && (h.opacity = parseFloat(RegExp.$1)), (e = h), (x.cssText = m)),
                              ...
                              T = 3 === this._transformType,
                                  ye
                                      ? u &&
                                        ...
                                        f && (x.WebkitBackfaceVisibility = this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden")))
                                      : (x.zoom = 1),
                                  c = p;
                              c && c._next;
                              ...
                              h
                                  ...
                                  : ((p = G(t, a, r) + ""),
                                    ...
                                    "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (d && b.test(f))
                                        ? (d || ((f = oe(f)), (f = (f.length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")")), (i = fe(v, a, p, f, !0, "transparent", i, 0, n)))
                                        : !d || (-1 === f.indexOf(" ") && -1 === f.indexOf(","))
                                        ? ((_ = parseFloat(p)),
                                          (c = _ || 0 === _ ? p.substr((_ + "").length) : ""),
                                          ("" === p || "auto" === p) &&
                                              ("width" === a || "height" === a ? ((_ = te(t, a, r)), (c = "px")) : "left" === a || "top" === a ? ((_ = Q(t, a, r)), (c = "px")) : ((_ = "opacity" !== a ? 0 : 1), (c = ""))),
                                          (g = d && "=" === f.charAt(1)),
                                          g ? ((u = parseInt(f.charAt(0) + "1", 10)), (f = f.substr(2)), (u *= parseFloat(f)), (m = f.replace(y, ""))) : ((u = parseFloat(f)), (m = d ? f.substr((u + "").length) || "" : "")),
                                          "" === m && (m = s[a] || c),
                                          ...
                                          c !== m &&
                                              ...
                                              (_ || 0 === _) &&
                                              ((_ = $(t, a, _, c)),
                                              "%" === m ? ((_ /= $(t, a, 100, "%") / 100), _ > 100 && (_ = 100), e.strictUnits !== !0 && (p = _ + "%")) : "em" === m ? (_ /= $(t, a, 1, "em")) : ((u = $(t, a, u, m)), (m = "px")),
                                              g && (u || 0 === u) && (f = u + _ + m)),
                                          g && (u += _),
                                          (!_ && 0 !== _) || (!u && 0 !== u)
                                              ? void 0 !== v[a] && (f || ("NaN" != f + "" && null != f))
                                                  ? ((i = new pe(v, a, u || _ || 0, 0, i, -1, a, !1, 0, p, f)), (i.xs0 = "none" !== f || ("display" !== a && -1 === a.indexOf("Style")) ? f : p))
                                                  : j("invalid " + a + " tween value: " + e[a])
                                              : ((i = new pe(v, a, _, u - _, i, 0, a, l !== !1 && ("px" === m || "zIndex" === a), 0, p, f)), (i.xs0 = m)))
              ...
              var De = function (t, e, i) {
                  ...
                  else for (s = t.childNodes, r = s.length; --r > -1; ) (n = s[r]), (a = n.type), n.style && (e.push(W(n)), i && i.push(n)), (1 !== a && 9 !== a && 11 !== a) || !n.childNodes.length || De(n, e, i);
              };
              return (
  ...
  (function (t) {
                          ...
                          _ = ("com.greensock." + e).split("."),
                              ...
                              r &&
                                  ...
                                  "function" == typeof define && define.amd
                                      ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + e.split(".").join("/"), [], function () {
                                            return c;
                                        })
      ...
      c("Ticker", function (t, e) {
          var i,
              ...
              f = function (t) {
                  ...
                  var e,
                      r = l.time - h;
                  (!i || r > 0 || t === !0) && (l.frame++, (h += r + (r >= o ? 0.004 : o - r)), (e = !0)), t !== !0 && (a = s(f)), e && l.dispatchEvent("tick");
              };
          T.call(l),
              (l.time = l.frame = 0),
              (l.tick = function () {
                              ...
                              n
                                  ? "string" != typeof n
                                      ? n.length && n !== t && n[0] && (n[0] === t || (n[0].nodeType && n[0].style && !n.nodeType))
                                          ? (a.splice(r--, 1), (this._targets = a = a.concat(l.call(n, 0))))
                                          : ((this._siblings[r] = z(n, this, !1)), 1 === h && this._siblings[r].length > 1 && U(n, this, null, 1, this._siblings[r]))
                                      : ((n = a[r--] = A.selector(n)), "string" == typeof n && a.splice(r + 1, 1))
                                  : a.splice(r--, 1);
      ...
      var D = (A._internals = {}),
          ...
          N = { none: 0, all: 1, auto: 2, concurrent: 3, allOnStart: 4, preexisting: 5, true: 1, false: 0 },
      ...
      var z = function (t, e, i) {
              var s,
                  r,
                  n = t._gsTweenID;
              if ((I[n || (t._gsTweenID = n = "t" + F++)] || (I[n] = { target: t, tweens: [] }), e && ((s = I[n].tweens), (s[(r = s.length)] = e), i))) for (; --r > -1; ) s[r] === e && s.splice(r, 1);
              return I[n].tweens;
          },
              ...
              for (n = r.length; --n > -1; )
                  (o = r[n]) === e ||
                      ...
                      (o._timeline !== e._timeline
                          ? ((l = l || Y(e, 0, f)), 0 === Y(o, l, f) && (u[p++] = o))
                          : _ >= o._startTime && o._startTime + o.totalDuration() / o._timeScale + 1e-10 > _ && (((f || !o._initted) && 2e-10 >= _ - o._startTime) || (u[p++] = o)));
      ...
      (s._init = function () {
          ...
          if (
              ((this._ease = h ? (h instanceof g ? (r.easeParams instanceof Array ? h.config.apply(h, r.easeParams) : h) : "function" == typeof h ? new g(h, r.easeParams) : v[h] || A.defaultEase) : A.defaultEase),
...
/*
   FILE ARCHIVED ON 03:32:43 Sep 04, 2016 AND RETRIEVED FROM THE
   INTERNET ARCHIVE ON 04:48:31 Feb 14, 2020.
...
captures_list: 424.851
PetaboxLoader3.resolve: 242.282 (2)
CDXLines.iter: 9.949 (3)
esindex: 0.016
exclusion.robots.policy: 0.21
PetaboxLoader3.datanode: 924.912 (5)
load_resource: 766.487
RedisCDXSource: 2.113
LoadShardBlock: 406.462 (3)
*/